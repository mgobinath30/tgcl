  ...
  const slides: Slide[] = useMemo(
    () => [
        ...
        bg: (
          <div className="absolute inset-0 -z-10">
            ...
            <div className="absolute inset-0 w-full h-full">
              <iframe
                src="https://www.youtube.com/embed/mVCsu0sKOsw?autoplay=1&mute=1&loop=1&playlist=mVCsu0sKOsw&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&fs=0&cc_load_policy=0&start=0&end=30"
            ...
            {[...Array(8)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-2 h-2 rounded-full ${
                  ...
                  i % 4 === 1 ? 'bg-emerald-400/40' :
                  i % 4 === 2 ? 'bg-cyan-400/40' : 'bg-white/40'
                }`}
                style={{
                  left: `${10 + i * 12}%`,
                  top: `${60 + (i % 3) * 10}%`,
          ...
          <div className="flex h-full items-center justify-center text-center">
            <div className="space-y-8 px-6 max-w-6xl">
              ...
              >
                ...
                <span className="text-lg tracking-wide font-medium">Virtual Hospital Tour</span>
              </motion.div>
              ...
              >
                {[
                  { icon: Award, text: "32+ Years Experience", color: "text-yellow-400" },
                  { icon: Users, text: "211+ Specialist Doctors", color: "text-blue-400" },
                  { icon: Shield, text: "Advanced Technology", color: "text-emerald-400" }
                ].map((item, index) => (
                  <motion.div
                    key={item.text}
              ...
              >
                {[
                  { number: 32, suffix: "+", label: "Years Experience", icon: Award },
                  { number: 211, suffix: "+", label: "Specialist Doctors", icon: Users },
                  { number: 1000, suffix: "+", label: "Successful Surgeries", icon: Heart }
                ].map((stat, index) => (
                  <motion.div
                    key={stat.label}
            ...
            {[...Array(12)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  ...
                  i % 4 === 2 ? 'bg-emerald-400/40' : 'bg-white/40'
                }`}
                style={{
                  left: `${5 + i * 8}%`,
                  top: `${70 + (i % 3) * 8}%`,
        ...
        content: (
          <div className="flex h-full items-center justify-center">
            <NestedCarousel
              ...
              items={[
                { key: "modern-facility", node: <InfrastructureCard title="Modern Facility" subtitle="State-of-the-art infrastructure" icon={<Building2 className="h-12 w-12 text-cyan-300" />} features={["Advanced Equipment", "Clean Environment", "Modern Design"]} /> },
                { key: "technology", node: <InfrastructureCard title="Advanced Technology" subtitle="Cutting-edge medical equipment" icon={<Zap className="h-12 w-12 text-cyan-300" />} features={["Digital Systems", "Precision Tools", "Latest Technology"]} /> },
                { key: "safety", node: <InfrastructureCard title="Safety Standards" subtitle="Highest safety protocols" icon={<Shield className="h-12 w-12 text-cyan-300" />} features={["Infection Control", "Emergency Systems", "Quality Assurance"]} /> },
                { key: "comfort", node: <InfrastructureCard title="Patient Comfort" subtitle="Comfortable healing environment" icon={<Heart className="h-12 w-12 text-cyan-300" />} features={["Comfortable Spaces", "Patient Care", "Healing Environment"]} /> },
              ]}
            />
          </div>
        ),
            ...
            {[...Array(10)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  ...
                  i % 3 === 1 ? 'bg-cyan-400/50' : 'bg-white/50'
                }`}
                style={{
                  left: `${8 + i * 9}%`,
                  top: `${65 + (i % 3) * 10}%`
          ...
          <div className="absolute inset-0 -z-10">
            ...
            {[...Array(14)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  i % 4 === 0 ? 'bg-slate-400/60' :
                  i % 4 === 1 ? 'bg-blue-400/60' :
                  i % 4 === 2 ? 'bg-cyan-400/60' : 'bg-white/60'
                }`}
                style={{
                  left: `${6 + i * 7}%`,
                  top: `${68 + (i % 4) * 8}%`
            ...
            {[...Array(12)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  ...
                  i % 3 === 1 ? 'bg-blue-400/60' : 'bg-white/60'
                }`}
                style={{
                  left: `${7 + i * 8}%`,
                  top: `${66 + (i % 3) * 12}%`
            ...
            {[...Array(10)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  ...
                  i % 3 === 1 ? 'bg-slate-400/60' : 'bg-cyan-400/60'
                }`}
                style={{
                  left: `${8 + i * 9}%`,
                  top: `${64 + (i % 3) * 12}%`
          ...
          <div className="absolute inset-0 -z-10">
            ...
            {[...Array(12)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  i % 4 === 0 ? 'bg-green-400/60' :
                  i % 4 === 1 ? 'bg-emerald-400/60' :
                  i % 4 === 2 ? 'bg-lime-400/60' : 'bg-white/60'
                }`}
                style={{
                  left: `${6 + i * 8}%`,
                  top: `${66 + (i % 4) * 8}%`
            ...
            {[...Array(10)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-3 h-3 rounded-full ${
                  ...
                  i % 3 === 1 ? 'bg-indigo-400/60' : 'bg-violet-400/60'
                }`}
                style={{
                  left: `${8 + i * 9}%`,
                  top: `${65 + (i % 3) * 10}%`
      ...
      },
      {
        ...
        bg: (
          <div className="absolute inset-0 -z-10">
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-900 via-blue-900 to-blue-950" />
          </div>
        ),
        content: (
          <div className="flex h-full items-center justify-center">
...
function BackgroundVideoSlider({ 
  ...
  return (
    <div className="absolute inset-0 w-full h-full">
      ...
      <div className="absolute inset-0 w-full h-full">
        <iframe
          src={`https://www.youtube.com/embed/${videos[currentVideoIndex]}?autoplay=1&mute=1&loop=1&playlist=${videos[currentVideoIndex]}&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&fs=0&cc_load_policy=0&start=0&end=30`}
